    ...
    stages {
        ...
        stage('Build') {
          ...
          steps {
               ...
               sh "curl -sS https://dl.yarnpkg.com/debian/pubkey.gpg | sudo apt-key add - echo 'deb https://dl.yarnpkg.com/debian/ stable main'" 
               sh 'sudo tee /etc/apt/sources.list.d/yarn.list'
